...
class Compiler {
    ...
    onInternalCompilerLoaded() {
        if (this.state.worker === null) {
            const compiler = typeof (window) !== 'undefined' && window['Module'] ? require('solc/wrapper')(window['Module']) : require('solc'); // eslint-disable-line
    ...
    loadRemoteVersion(version) {
        ...
        const compiler = require('solc'); // eslint-disable-line
